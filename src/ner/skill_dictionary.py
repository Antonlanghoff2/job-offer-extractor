...
SKILL_DICTIONARY: "OrderedDict[str, Dict[str, object]]" = OrderedDict(
    [
        ...
        ("Développement d'API", {"aliases": ["developpement d'api", "développement d'api", "api development"], "category": "backend"}),
        ("GitLab CI/CD", {"aliases": ["gitlab ci", "gitlab ci/cd", "gitlab pipeline", "gitlab pipelines"], "category": "outillage"}),
        ("Tests automatisés", {"aliases": ["tests automatisés", "tests automatises", "automatisation des tests", "automated tests"], "category": "qualite"}),
        ("Management d'équipe", {"aliases": ["management d'équipe", "management equipe", "gestion d'équipe", "gestion equipe", "encadrement d'équipe", "encadrement equipe"], "category": "management"}),
        ("Coordination technique", {"aliases": ["coordination technique"], "category": "management"}),
        ("Planification", {"aliases": ["planification", "planification des interventions", "ordonnancement"], "category": "management"}),
        ("Maintenance technique", {"aliases": ["maintenance technique", "maintenance du parc", "maintenance du matériel", "maintenance du materiel"], "category": "maintenance"}),
        ("Réseau audio", {"aliases": ["réseau audio", "reseau audio", "audio network"], "category": "spectacle"}),
        ("Mixage audio", {"aliases": ["mixage audio"], "category": "spectacle"}),
        ("Console numérique", {"aliases": ["console numérique", "console numerique", "console digitale"], "category": "spectacle"}),
        ("Dante", {"aliases": ["dante"], "category": "spectacle"}),
